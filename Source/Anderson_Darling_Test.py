...
languages = {
    "zh": {
        ...
        "table_header_column_name": "列名",
        "anderson_darling_stat": "Anderson-Darling 统计量",
        "critical_value_05": "临界值 (0.05)",
    ...
    "en": {
        ...
        "table_header_column_name": "Column Name",
        "anderson_darling_stat": "Anderson–Darling Statistic",
        "critical_value_05": "Critical Value (0.05)",
        ...
        try:
            ...
            for col_idx in range(1, columns + 1):
                ...
                if column_values:
                    ...
                    values = [ad_statistic, critical_value, interpretation]
                    ...
                    plt.title(languages[self.current_language]["normal_dist_title"].format(col_name=col_name, mu=mu, std=std))
            ...
            columns_stats = [
                languages[self.current_language]["anderson_darling_stat"],  # 替换1
                languages[self.current_language]["critical_value_05"],  # 替换2
                languages[self.current_language]["result_interpretation"]  # 结果解读（保持不变）
            ]
            headers = [languages[self.current_language]["table_header_column_name"]] + columns_stats
